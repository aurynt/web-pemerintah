                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="left-image">
                                        <img
                                            src="../../../public/assets/images/left-infos.jpg"
                                            alt=""
                                        />
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="section-heading">
                                        ...
                                        <p>
                                            ...
                                            for any purpose. You are not allowed
                                            to redistribute the downloadable ZIP
                                            file of Tale SEO Template on any
                                    ...
                                    <p className="more-info">
                                        ...
                                        dolor dolor sit amet, consectetur
                                        adipiscing elit, sed doers eiusmod.
                                    </p>
                                </div>
                            </div>
